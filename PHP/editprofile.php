<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $data = array('name'       => $_POST['name'],
                    ...
                    'DOB'          => $_POST['year']);
        $con = array('user_id' => $user_no);
        $wpdb->update($table,$data,$con);
    }
    ...
    if(isset($user_no))  
    {
        ...
        $value = $wpdb->get_results("select * from wp_user646 where user_id='$user_no'");
                    ...
                    <div class="form-group">  
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group date" >
                                <input type='date' class="form-control date-picker" name="year" value="<?php echo $user_edit[5] ;?>" />
