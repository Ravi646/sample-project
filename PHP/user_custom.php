...
function cltd_example_install()
{
    ...
    first_q varchar(255) NOT NULL,
    second_q varchar(255) NOT NULL,
    DOB date('Y-m-d') NOT NULL
    );";
...
class Custom_Table_Example_List_Table extends WP_List_Table
{
    ...
    function get_columns()
    {
        $columns = array(
            ...
            'user_id' => __('UserID', 'cltd_example'),
        );
        return $columns;
    }
    /**
...
{
    add_menu_page(__('Users', 'cltd_example'), __('Users', 'cltd_example'), 'activate_plugins', 'persons', 'cltd_example_persons_page_handler');
    add_submenu_page('persons', __('Users', 'cltd_example'), __('Users', 'cltd_example'), 'activate_plugins', 'persons', 'cltd_example_persons_page_handler');
...
<table cellspacing="2" cellpadding="5" style="width: 100%;" class="form-table">
    ...
    <tr class="form-field">
        ...
        <td>
            <input type="checkbox" name="qual[]" value="ssc" id="val_ssc" <?php echo esc_attr($item['qualification']);?>>SSC
            <input type="checkbox" name="qual[]" value="hsc" id="val_ssc" <?php echo esc_attr($item['qualification']);?>>HSC
            <input type="checkbox" name="qual[]" value="graduate" id="val_ssc" <?php echo esc_attr($item['qualification']);?>>Graduate
        </td>
    </tr> 
     <tr class="form-field">
        <th valign="top" scope="row">
            <label for="year"><?php _e('E-Mail', 'cltd_example')?></label>
        </th>
        <td>
